...
; JKL 11/29/2024 -- I'm assuming this file is released under the GPL2 license,
; because it was included in DASM, and the DASM project as a whole is released
; under GPL2.  The file itself contains no license or copyright info.
